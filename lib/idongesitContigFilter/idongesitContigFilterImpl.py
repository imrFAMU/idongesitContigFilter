...
# Tutorial 7.9 - not used - imr (although I did an install of KBaseReport in Debian)
# from KBaseReport.KBaseReportClient import KBaseReport

#END_HEADER


class idongesitContigFilter:
    '''
    Module Name:
...
This sample module contains one small method that filters contigs.
    ...
    def run_idongesitContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_idongesitContigFilter

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_idongesitContigFilter function. Params=' + pformat(params))
        ...
        #END run_idongesitContigFilter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_idongesitContigFilter return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]

    def run_idongesitContigFilter_max(self, ctx, params):
        """
        ...
        # ctx is the context object
        # return variables are: output
        #BEGIN run_idongesitContigFilter_max
        # Inside run_idongesitContigFilter_max(), after #BEGIN run_idongesitContigFilter_max, before any other code
        ...
        # print what parameters are being passed to the method
        print(params['min_length'], params['max_length'], params['assembly_ref'])
        
        output = {}

        # Inside run_idongesitContigFilter_max()
        assembly_util = AssemblyUtil(self.callback_url)
        fasta_file = assembly_util.get_assembly_as_fasta({'ref': params['assembly_ref']})
        print(fasta_file)

        # Inside idongesitContigFilterImpl#run_idongesitContigFilter_max, after you have fetched the fasta file:
        ...
        #END run_idongesitContigFilter_max

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_idongesitContigFilter_max return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]
